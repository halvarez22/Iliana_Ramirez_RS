                            ...
                            <div className="space-y-6">
                                ...
                                <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
                                    <div className="flex items-start space-x-4">
                                        <div className="w-12 h-12 bg-ileana-orange rounded-full flex items-center justify-center flex-shrink-0">
                                ...
                                <div className="bg-white rounded-lg shadow-lg p-6 hover:shadow-xl transition-shadow duration-300">
                                    <div className="flex items-start space-x-4">
                                        <div className="w-12 h-12 bg-ileana-navy rounded-full flex items-center justify-center flex-shrink-0">
                                            <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="container mx-auto px-4 sm:px-6">
                    ...
                    <div className="max-w-4xl mx-auto">
                        <div className="bg-gray-200 rounded-lg shadow-lg overflow-hidden" style={{ height: '400px' }}>
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3732.123456789!2d-101.94244681098512!3d21.362296289321435!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMjHCsDA4JzQyLjgiTiAxMDHCsDQxJzI5LjQiVw!5e0!3m2!1ses!2smx!4v1234567890123!5m2!1ses!2smx"
                                width="100%"
                                height="400"
                                style={{ border: 0 }}
                                allowFullScreen
