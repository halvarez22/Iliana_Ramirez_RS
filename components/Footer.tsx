            ...
            <div className="container mx-auto px-4 sm:px-6 py-8 md:py-12">
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 md:gap-6">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            <li><a href="#" className="text-ileana-orange hover:text-orange-400 transition-colors">Aviso de Privacidad</a></li>
                            <li><a href="#" className="text-ileana-orange hover:text-orange-400 transition-colors">Términos y Condiciones</a></li>
                        </ul>
                    </div>
                    <div>
